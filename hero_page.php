...
<div class="card-container">
  <div class="card">
    <a href="https://cpsc.umw.edu/Team_Panther/CPSC350_Final_Project/character_page.php?character=7">
    <img src="https://www.designbolts.com/wp-content/uploads/2014/06/Ironman-2.jpg" alt="Avatar" style="width:100%">
    </a>
    <div class="container">
      <h4><b>Iron Man</b></h4>
      <p>The one & only.</p>
  ...
  <div class="card">
    <a href="https://cpsc.umw.edu/Team_Panther/CPSC350_Final_Project/character_page.php?character=4">
    <img src="https://www.designbolts.com/wp-content/uploads/2014/06/spiderman-2.jpg" alt="Avatar" style="width:100%" class="flipped">
    </a>
    <div class="container">
      <h4><b>Spider Man</b></h4>
      <p>Into the Spiderverse.</p>
    </div>
  </div>
  <div class="card">
    <a href="https://cpsc.umw.edu/Team_Panther/CPSC350_Final_Project/character_page.php?character=5">
    <img src="https://www.designbolts.com/wp-content/uploads/2014/06/Captain-america.jpg" alt="Avatar" style="width:100%" class="flipped">
    </a>
    <div class="container">
  ...
  <div class="card">
    <a href="https://cpsc.umw.edu/Team_Panther/CPSC350_Final_Project/character_page.php?character=8"> 
    <img src="https://www.designbolts.com/wp-content/uploads/2014/06/Daredevil.jpg" alt="Avatar" style="width:100%" class="flipped">
    </a>
    <div class="container">
      <h4><b>Daredevil</b></h4>
      <p>Just because he's blind doesn't mean he can't see. Nevermind, that's exactly what it means.</p>
    </div>
  </div>
</div>
</div>
...
try {
    $result = $conn->query("SELECT s.superhero_id AS id, s.image_url AS url, a.hero_alias AS al, s.description AS d FROM Superhero s INNER JOIN Hero_Alias a ON a.alias_id=s.main_alias_id AND real_name NOT IN ('Peter Parker', 'Steve Rogers', 'Tony Stark', 'Matthew Murdock') AND s.alignment='good';");
} catch (Exception $e) {
